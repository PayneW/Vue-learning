        ...
        .electrical-appliance-brand {
            ...
            .classification {
                ...
                p.classification-more-btn {
                    ...
                    .down-red-arrow-icon {
                        background: url("../../../assets/images/arrow-icon/down-red-arrow-icon.svg") no-repeat center;
            ...
            .brands {
                ...
                .down-grey-arrow-icon {
                    background: url("../../../assets/images/arrow-icon/down-grey-arrow-icon.svg") no-repeat center;
                    background-size: contain;
                }
